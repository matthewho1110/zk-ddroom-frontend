...
function LandingPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await axios.post(`${process.env.BACKEND_URI}/register/sendEmail`, body, {
        headers: {
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta name="description" content="Drta dataroom, Powered by Starwave" />
      ...
      <main className={styles.main}>
        ...
        <code className={styles.code}>
          Upon successful verification, our expert will get in touch with you
          very shortly
        </code>
