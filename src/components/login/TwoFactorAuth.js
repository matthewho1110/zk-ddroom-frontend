    ...
    <>
      {currentPage === PAGES.HOME && (
        ...
        >
          ...
          <Typography variant="h4" sx={{ mb: 2 }} style={{ color: "#2E59A9" }}>
          ...
          <Typography
            ...
            mb={2}
          >
            Choose one of the following options to verify your identity:
          </Typography>
          {authenticators.hasOwnProperty("mobileAuthenticator") && (
            ...
            >
              <Box>Get a code from your mobile authenticator app</Box>
          ...
          {authenticators.hasOwnProperty("smsAuthenticator") && (
            <Box>
              <Box
                ...
                mb="1.5rem"
                style={{ cursor: "pointer" }}
                onClick={() => setCurrentPage(PAGES.PHONENUMBER)}
              >
                <Box
                  sx={{
                    typography: "h5",
              ...
              <Box
                ...
                onClick={() => router.push("https://ZK.io")}
              >
                Contact Support
              </Box>
            </Box>
