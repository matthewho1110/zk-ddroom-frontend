      ...
      .catch((err) => {
        if (err.response) {
          switch (err.response.status) {
            case 400:
              setAlert("Please fill in all the required fields.", "warning");
              break;
            case 404:
              setAlert(
  ...
  if (
    ...
    return (
      <div className={styles.container}>
        <img src="/images/register/bg2.svg" className={styles.back1}></img>
            ...
            <Box width="100%" onSubmit={onSubmit} component="form">
              ...
              >
                {QUESTION_MAP.map((res, idx) => {
                  return (
                    <MenuItem
                      disabled={getValues("secondSecurityQuestion") === res}
                      value={res}
                      key={idx}
                    >
                      {res}
              ...
              >
                {QUESTION_MAP.map((res, idx) => {
                  return (
                    <MenuItem
                      disabled={getValues("firstSecurityQuestion") === res}
                      value={res}
                      key={idx}
                    >
                      {res}
        ...
        <img src="/images/register/bg1.svg" className={styles.back2}></img>
      </div>
    );
  }
}
