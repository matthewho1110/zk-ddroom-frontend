  ...
  if (isLoggedIn == null || needLoginFirst || notActiveMember) {
    ...
    return (
      <Box>
        <ErrorPage
          message={
            "Admin account is not allowed to access Zk-group on the mobile app. Please use the desktop version."
          }
        />
      </Box>
    );
    ...
    return (
      <Box sx={{ display: "flex", width: "100%", overflowX: "hidden" }}>
        ...
        {isMobile && showMenu && (
          ...
          >
            <SubjectIcon fontSize="large" onClick={() => setOpen(true)} />
            <Typography
              variant="h1"
              noWrap
              fontSize="18px"
